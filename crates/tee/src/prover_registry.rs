use abi::{ProverRegistryStub::{Poe, Proof}, ProverRegistryStub::ProverRegistryStubErrors};
use alloy::{
    primitives::{Address, Bytes}, rpc::types::TransactionReceipt, sol_types::SolEvent
};
...
pub use abi::ProverRegistryStub::registerCall as RegisterCall;
